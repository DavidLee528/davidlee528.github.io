...
<div class="container">
    <div class="text">
        ...
        <p>
            Tianhao holds a BEng in Information Security and leads the <em>Special Interest Group in Modern Interdisciplinary Research (SIGMIR)</em> (~20 members). He also serves as peer review experts for prestigious journals, conferences, and workshops, including AAAI, IJCAI, COLING, IJCNN, ISBI, JRESS, and ACM TIST. In addition, Tianhao serves as contributor to the <a href="https://mlcommons.org/" target="_blank">MLCommons</a> AI Risk &amp; Reliability (AIRR) Working Group, contributing to the release of <a href="https://mlcommons.org/ailuminate/" target="_blank">AILuminate</a>. He also actively contributes to NVIDIA’s widely recognized open-source project <a href="https://github.com/NVIDIA/garak" target="_blank">NVIDIA/garak</a> (<strong>3.5K+ stars on Github</strong>).
        </p>
    </div>
    <div class="image">
